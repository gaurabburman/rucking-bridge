...
module.exports = async (req, res) => {
    ...
    try {
        // 2. FIREBASE SECURE INITIALIZATION (Merging your specific Service Account data)
        ...
        // Strictly capturing every single field from user UI inputs and calculation results
        const singleLifeEntry = {
            ...
            // USER RAW INPUTS (Respecting KG/LB Engines)
            ...
            timestamp: new Date() // Accurate mission locking
        };

        // 6. ACTION: DUAL COLLECTION DEPOSIT
        // Insert into Personal Logs (Maintains 15-day history)
        await db.collection('personal_logs').insertOne(singleLifeEntry);
        
        // Insert into Leaderboard (Single Life Entry per mission)
